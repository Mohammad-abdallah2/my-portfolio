...
?>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light" style="background: #000;">
                        <div class="container">
                            ...
                            <a class="navbar-brand logo_h" href="index.php"><img
                                        src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['icon']); ?>"
                                        style="
							width: 200px;
							height: 50px;
							" alt=""></a>
                            ...
                            <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                                <ul class="nav navbar-nav menu_nav justify-content-end">
                                    ...
                                    <li class="nav-item "><a class="nav-link" href="#Business-summary">Business
                                            summary</a></li>
            ...
            <div class="row justify-content-center">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) :
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="feature_item text-center">
                                        <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['icons']); ?>"
                                             style="width:75px !important; height:75px !important;" alt="">
                                    </div>
                                </div>
                            <?php endwhile; ?>
                        <?php endif; ?>
                ...
                <div class="offset-lg-2 col-lg-4 col-md-6">
                    <div class="client-info">
                        ...
                        <div class="call-now d-flex">
                            <div>
                                <img src="img/frontend.svg" alt="Frontend mentor icon" width="50px" height="auto">
                            </div>
                            <div class="ml-15">
                                <?php
                                ...
                                ?>
                                <p>Frontend Mentor</p>
                                <a href="<?php echo $url5; ?>" target="_blank">
                                    <h3 style=" cursor: pointer;">Click here</h3>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="call-now d-flex">
                            ...
                            <div class="ml-15">
                                <p>Github</p>
                                <a href="mailto:mohammadadballah4@gmail.com?Subject=" target="_top">
                                    <a href="<?php echo $url4; ?>" target="_blank">
                                        <h3 style=" cursor: pointer;">Click here</h3>
                                    </a>
                                </a>
                            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <div class="main_title">
                        ...
                        <p>
                            The services that I implement quickly and proficiently and the ability to do more than one
                            task
                        </p>
                    </div>
                </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="feature_item">
                                <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['icon']); ?>"
                                     alt="" style="width:63px; height:63px;">
                            ...
                            <div class="col-lg-4 col-md-6 all">
                                <div class="portfolio_box">
                                    <div class="single_portfolio">
                                        <img class="img-fluid mw-100"
                                             src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['image']); ?>"
                                             alt="">
                                        <div class="overlay"></div>
                                        <a href="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['image']); ?>"
                                           class="img-gal">
                                            <div class="icon">
    ...
    <?php //echo base64_encode($row['image']); ?><!--" alt="">-->
    <!--									</div>-->
    <!--									<div class="col-lg-8">-->
                ...
                <div class="container">
                        ...
                        <div class="col-lg-12">
							...
							" alt="">
                                ...
                                <div class="footer_social">
                                    ...
                                    <a href="<?php echo $url5; ?>" target=_blanck><img src="img/frontend.svg"
                                                                                       alt="Frontend mentor icon"
                                                                                       width="22px" height="auto"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row footer_bottom justify-content-center">
                        <p class="col-lg-8 col-sm-12 footer-text">
                            ...
                            All rights reserved | This template is made with Clever Mind POB by MOHAMMAD ABDUALLAH
                            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
